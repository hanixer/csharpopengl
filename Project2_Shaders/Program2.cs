...
{
    class Program2 : OpenTK.GameWindow
    {
        float[] vertices1 =
        {
        ...
        private void OnLoad(object sender, EventArgs e)
        {
            ...
            shader = new Shader("../../Shaders/shader2.vert", "../../Shaders/shader.frag");
        ...
        {
            using (Program2 program = new Program2())
            {
                program.Run();
            }
